...
| **Versions** | **23.05**, **24.10**, **25.12**, **snapshot** (internal SDK option) — [`sdk-build-matrix.md`](sdk-build-matrix.md) |
...
./scripts/docker-sdk.sh build-all                                # 23.05–snapshot × both targets
```
