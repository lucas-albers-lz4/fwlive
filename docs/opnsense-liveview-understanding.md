...
**Related:** [UI design target (LuCI client-side)](fwlive-ui-design-target.md) · [OPNsense parity matrix (UI/API)](opnsense-liveview-parity.md) · [OpenWrt event schema](openwrt-fwlive-schema.md) · [staged plan](fwlive-development-plan.md) · logic [`core/fwlive-log.js`](../core/fwlive-log.js) / LuCI [`fwlive/log.js`](../openwrt-feed/luci-app-fwlive/htdocs/luci-static/resources/fwlive/log.js) / [`fwlive.js`](../openwrt-feed/luci-app-fwlive/htdocs/luci-static/resources/view/status/fwlive.js)
