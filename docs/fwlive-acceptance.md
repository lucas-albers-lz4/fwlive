...
**Production target:** armsr **24.10.8**. **23.05.5** is supported (EOL). **22.03.7** / **21.02.7** are historical lab notes only — see [supported releases](supported-releases.md#2305x), [22.03 notes](supported-releases.md#2203x-eol), and [21.02 notes](supported-releases.md#2102x-legacy-fw3).
