...
| `/tmp` used for ruleset dumps is a real directory with the sticky bit (fail closed) | `host` | `_fwlive_tmp_dir_ok`; `tests/fwlive-rules-map.test.js` `testTmpDirSticky` |
