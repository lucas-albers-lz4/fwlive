...
| Adaptive poll reply carries `messages_received` (Layer 1: always `0` — no post-filter ash scan; accurate count deferred) | `host` | `tests/fwlive-rpcd-security.test.js` / jshn-compat |
