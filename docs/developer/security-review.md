...
| Layer 2 client backoff: visibility pause, RTT cadence, adaptive/shed banners; resolve honors `disabled:load` | `host` | `tests/fwlive-view-layer2-backoff.test.js`; banners via `textContent` only (`#fwlive-adaptive`) |
