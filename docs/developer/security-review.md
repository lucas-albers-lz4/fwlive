...
| #370 installed matrix | 2026-09-20 | Delta + host + lab | Armsr IPK: uninstall restoration plus root-SSH `ubus` observations (not R8 session proof) in [#389 evidence](../evidence/issue-389-2026-09-20.md). 24.10 x86 IPK and 25.12 APK: uninstall restoration; x86/APK same-version reinstall is the no-op preservation table (#406), not hook proof. R8 session-authenticated cells remain open ([#392](../evidence/issue-392-2026-09-20.md) covers R4b only). |
