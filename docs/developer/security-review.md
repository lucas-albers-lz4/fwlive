...
> **Current delta:** 2026-09-19 #383 follow-up to #373: no-zone candidates now travel through `logging_status` and render as text nodes in the LuCI empty state and toolbar; host-focused validation; no ACL or HTML sink change.
