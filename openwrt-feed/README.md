...
- Menu visible when the `luci-app-fwlive` ACL is granted (no `nft`/`iptables` binary check)
- **fw4/nft** primary on **23.05+**; log lines tagged **iptables** still classify. OpenWrt **21.02** / **22.03** are unsupported
