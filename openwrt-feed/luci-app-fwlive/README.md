...
| `htdocs/luci-static/resources/fwlive/poll-coordinator.js` | Request coalescing, visibility, cadence, and disposal ([ownership](../../docs/developer/architecture.md#poll-lifecycle-ownership)) |
